[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32l23x-cmake-vscode)](https://github.com/burakenez/gd32l23x-cmake-vscode/tags/)

# GD32L23x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32L23x Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32L23x Demo Suites V2.6.0](https://www.gd32mcu.com/en/download)_** and **_[GD32L23x Firmware Library V2.4.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32l23x-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32L23x**
- **Version:** `V2.4.0 (2026-02-02)`
- **Path:** `Drivers/CMSIS/GD/GD32L23x`
- **Source:** `GD32L23x Demo Suites V2.6.0`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32l23x_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32l23x_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32l23x_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32l23x.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32l23x.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32L233C_START              # Board support package for GD32L233C_START
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32L23x
│           │   └── GD32L23x_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32l23x_flash.ld  # Linker script (memory regions)
│           └── GD32L23x.svd             # SVD file for peripheral register views
